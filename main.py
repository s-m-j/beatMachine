# Build Your Own Beat Machine from freecodecamp.org
import pygame
...
pygame.display.set_caption('BitMaker')
label_font = pygame.font.SysFont('Roboto-Bold.ttf', 32)
medium_font = pygame.font.SysFont('Roboto-Bold.ttf', 24)
...
kick = mixer.Sound('sounds/bass.WAv')
...
def draw_grid(clicks, beat, actives):
    ...
    bottom_box = pygame.draw.rect(screen, (128, 128, 128), [0, HEIGHT - 200, WIDTH, 200], 5)
    ...
    for i in range(beats):
        for j in range(instruments):
            ...
            rect = pygame.draw.rect(screen, color, [i * ((WIDTH - 200) // beats) + 200, (j * 100) + 5,
                                                   ((WIDTH - 200) // beats) - 5, ((HEIGHT - 200) // instruments)], 0, 3)
